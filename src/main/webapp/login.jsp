        ...
        <section class="m-b-lg">
            ...
            <form action="<%=basePath%>user/login" method="post">
                <div class="form-group">
                    <input type="text" placeholder="用户名" class="form-control rounded input-lg text-center no-border"
                           name="userName">
                </div>
                <div class="form-group">
                ...
                <div class="text-center m-t m-b"><a href="<%=basePath%>/signup.jsp"><small>忘记密码?</small></a></div>
                <div class="line line-dashed"></div>
                <p class="text-muted text-center"><small>没有账号?</small></p>
                <a href="<%=basePath%>/signup.jsp" class="btn btn-lg btn-info btn-block rounded">注册</a>
            </form>
        </section>
    </div>
</section>
...
<footer id="footer">
    <div class="text-center padder">
        <p>
            <small>Guide Music welcome come to you regedister<br>&copy; 2020-02</small>
