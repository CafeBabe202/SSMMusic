				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" action="user/adminLogin" method="post">
								...
								<div class="bottom">
									<span class="helper-text">${msg}<i class="fa fa-lock"></i> <a
										href="#">忘记密码?</a></span>
								</div>
							</form>
						</div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">欢迎来到 优就业Music</h1>
							<p>后台管理系统</p>
						</div>
					</div>
