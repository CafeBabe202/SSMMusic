...
<section class="vbox">
    <header
        ...
        <div class="navbar-header aside bg-info nav-xs">
            <a class="btn btn-link visible-xs"
               data-toggle="class:nav-off-screen,open" data-target="#nav,html">
                <i class="icon-list"></i>
            </a> <a href="<%=basePath%>" class="navbar-brand text-lt"> <i
                class="icon-earphones"></i> <img src="<%=basePath%>images/logo.png" alt="."
        ...
        <div class="navbar-right ">
                ...
                <ul class="nav navbar-nav m-n hidden-xs nav-user user">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu animated fadeInRight">
                            <li><a href="<%=basePath%>/user/logout"><span class="glyphicon glyphicon-log-out"></span>&nbsp;退出登录</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <span>&emsp;</span>
            <a target="_blank" href="<%=basePath%>user/toAdminLogin"><span
                        ...
                        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                            <nav class="nav-primary hidden-xs">
                                <ul class="nav bg clearfix">
                                    ...
                                    <li><a href="<%=basePath%>/music/genres"> <i
                                            class="icon-music-tone-alt icon text-info"></i> <span
                                            class="font-bold">流派</span>
                                    </a></li>
                                    <li><a href="<%=basePath%>/video" data-target="#content"
                            ...
                            <div class="dropdown dropup wrapper-sm clearfix">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
										<span class="thumb-sm avatar pull-left m-l-xs"> <img
                                                src="<%=basePath%>images/a3.png" class="dker" alt="..."> <i
                                                class="on b-black"></i>
                        ...
                        <section class="vbox">
                            <section class="scrollable padder-lg w-f-md" id="bjax-target">
                                ...
                                <div class="row row-sm">
                                    <c:if test="${not empty discoverMusicList}">
                                        <c:forEach var="m" items="${discoverMusicList}" varStatus="st">
                                            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                                                <div class="item">
                                                    <div class="pos-rlt">
                                                        ...
                                                        <a href="#"><img src="/musicfile/${m.musicphotourl}" alt=""
                                                                         class="r r-2x img-full"></a>
                                                    </div>
                                                    <div class="padder-v">
                                                        <a href="#" class="text-ellipsis">${m.musicname }</a> <a
                                                            href="#"
                                                            class="text-ellipsis text-xs text-muted">${m.singerName}</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <c:if test="${not empty newMusicList }">
                                                <c:forEach var="m" items="${newMusicList}" varStatus="st">
                                                    <div class="col-xs-6 col-sm-3">
                                                        <div class="item">
                                                            <div class="pos-rlt">
                                                                ...
                                                                <a href="#"><img src="/musicfile/${m.musicphotourl}"
                                                                                 alt="${m.musicname }"
                                                                                 class="r r-2x img-full"></a>
                                                            </div>
                                                            <div class="padder-v">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="list-group bg-white list-group-lg no-bg auto">
                                            ...
                                            <c:if test="${not empty musicRankList}">
                                                <c:forEach var="m" items="${musicRankList}" varStatus="st">
                                                    <a href="#" class="list-group-item clearfix jp-play-me TopSongs"
                                                       st="${st.index}"> <span
                                                            class="pull-right h2 text-muted m-l">${st.index+1}
                                                    </span> <span class="pull-left thumb-sm avatar m-r"> <img
                                                            src="/musicfile/${m.musicphotourl}" alt="${m.musicname}">
														</span> <span class="clear"> <span>${m.musicname }</span> <small
                                                            class="text-muted clear text-ellipsis">${m.singerName}</small>
														</span>
                                                    </a>
                                                </c:forEach>
                                            </c:if>
                        ...
                        <section class="vbox animated fadeInRight">
                            <section class="w-f-md scrollable hover">
                                ...
                                <ul class="list-group no-bg no-borders auto m-t-n-xxs">
                                    <c:if test="${not empty singerRankList }">
                                        <c:forEach var="s" items="${singerRankList}">
                                            <li class="list-group-item"><span
                                                    class="pull-left thumb-xs m-t-xs avatar m-l-xs m-r-sm">
														<img src="/musicfile/${s.singerphotourl}" alt="..."
                                                             class="img-circle listen" singerId="${s.singerid}"> <i
                                                    class="on b-light right sm"></i>
												</span>
                                                <div class="clear">
                                                    <div>
                                                        <a href="<%=basePath%>music/getMusicBySingerId?sid=${s.singerid}"
                                                           class="listen" singerId="${s.singerid}">${s.singername }</a>
                                                    </div>
...
<script type="text/javascript" src="<%=basePath%>js/slimscroll/jquery.slimscroll.min.js"></script>
...
//			    $(this).parent().parent().parent().find(".item-overlay").toggleClass('active');
    ...
    $(".RondomSongs").click(function () {
        ...
        if (r.indexOf('active') >= 0) {
            ...
            myPlaylist.remove();
            var newSongs = ${discoverMusicJson};
            if (newSongs.length > 0) {
                for (var i = 0; i < newSongs.length; i++) {
                    myPlaylist.add({
                        title: newSongs[i].musicname,
