                                ...
                                <section class="vbox animated fadeInUp">
                                    <section class="scrollable hover">
                                        ...
                                        <div
                                            ...
                                            <c:if test="${nowType.musictypeid==0 }">
                                                <a href="<%=basePath%>music/genres?nowTypeId=${nowType.musictypeid }"
                                                   class="list-group-item active">
                                                    全部 </a>
                                            </c:if>
                                            <c:if test="${nowType.musictypeid!=0 }">
                                                <a href="<%=basePath%>music/genres?nowTypeId=${nowType.musictypeid }"
                                                   class="list-group-item"> 全部 </a>
                                            </c:if>
                                            <c:if test="${not empty musicTypeList }">
                                                <c:forEach var="musicty" items="${musicTypeList }">
                                                    <c:if test="${musicty.musictypeid==nowType.musictypeid }">
                                                        <c:set var="nowtypename"
                                                               value="${musicty.musictypename }"></c:set>
                                                        <a class="list-group-item active"
                                                           href="<%=basePath%>music/genres?nowTypeId=${musicty.musictypeid}">
                                ...
                                <section class="vbox">
                                    <section class="scrollable padder-lg">
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <c:if test="${not empty nowTypeMusicInfo.list }">
                                                <c:set var="muindex" value="1"></c:set>
                                                <c:forEach var="pm" items="${nowTypeMusicInfo.list}" varStatus="st">
                                                        ...
                                                        <div class="item">
                                                            <div class="pos-rlt">
                                                                ...
                                                                <a href="track-detail.html"><img
                                                                        src="/musicfile/${pm.musicphotourl }" alt=""
                                                            ...
                                                            <div class="padder-v">
                                                                <a href="track-detail.html" data-bjax
                                                                   ...
                                                                   data-replace="true"
                                                                   class="text-ellipsis">${pm.musicname }</a>
                                                                <a href="track-detail.html" data-bjax
                                                                   data-target="#bjax-target" data-el="#bjax-el"
                                                                   data-replace="true"
                                                                   class="text-ellipsis text-xs text-muted">${pm.singerName}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </c:forEach>
                                        ...
                                        <ul class="pagination pagination">
                                            <c:if test="${nowTypeMusicInfo.pageNum<2 }">
                                                <li><a><i class="fa fa-chevron-left"></i></a></li>
                                            </c:if>

                                            <c:if test="${nowTypeMusicInfo.pageNum>=2 }">
                                                <li>
                                                    <a href="<%=basePath%>music/genres?nowTypeId==${nowType.musictypeid}&pageNO=${nowTypeMusicInfo.pageNum-1}">
                                            ...
                                            <c:if test="${not empty nowTypeMusicInfo.list }">
                                                <c:forEach begin="1" end="${nowTypeMusicInfo.pages }" step="1" var="i">
                                                    <c:if test="${i==nowTypeMusicInfo.pageNum}">
                                                        <li class="active"><a>${i}</a></li>
                                                    </c:if>
                                                    <c:if test="${i!=nowTypeMusicInfo.pageNum}">
                                                        <li>
                                                            <a href="<%=basePath%>music/genres?nowTypeId=${nowType.musictypeid}&pageNO=${i}">${i}</a>
                                                        </li>
                                                    </c:if>
                                                </c:forEach>
                                            </c:if>

                                            <c:if test="${nowTypeMusicInfo.pageNum+1<=nowTypeMusicInfo.pages }">
                                                <li><a
                                                        href="<%=basePath%>music/genres?nowTypeId=${nowType.musictypeid}&pageNO=${nowTypeMusicInfo.pageNum+1 }"><i
